...
class WakalaRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        // Check if new Wakala verify Contract OTP rules
        elseif ($this->is('api/new_wakala/verify')) {
            return $this->newWakalaVerifyRules();
        }
    }
    ...
    private function newWakalaVerifyRules()
    {
        return [
            'RejectComment' => 'required_if:VerificationStatus,3'
        ];
