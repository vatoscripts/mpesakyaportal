    ...
    <nav class="sidebar" data-sidebar-anyclick-close>
        ...
        <ul class="sidebar-nav">
            ...
            @if ($user['Role'] === 6 || $user['Role'] === 7 || $user['Role'] === 8 )
                ...
                <li class>
                    <a href="#New-Wakala-verification" title="Layouts" data-toggle="collapse">
                    <em class="icon-note"></em>
                    <span>New Wakala Verification</span>
                    </a>
                    <ul class="sidebar-nav sidebar-subnav collapse" id="New-Wakala-verification">
                        <li class="sidebar-subnav-header">New Wakala Verification</li>

                        <li class>
                            <router-link to="/new_wakala/unverified">
                            <span>New Unverified Wakala</span>
                            </router-link>
                        </li>
                        <!-- <li class>
                            <router-link to="/new_wakala/approved">
                                <span>New Approved Wakala</span>
                            </router-link>
                        </li> -->
                        <!-- <li class>
                            <router-link to="/wakala/declined">
                                <span>New Declined Wakala</span>
                            </router-link>
                        </li> -->
                        <!-- <li class>
                            <router-link to="/wakala/status">
                                <span>New Wakala with Status</span>
                            </router-link>
                        </li> -->
