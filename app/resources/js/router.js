...
import ViewNewUnverifiedWakala from "./components/New_wakala/NewUnverifiedWakala.vue";

import ViewSingleNewUnverifiedWakala from "./components/New_wakala/ViewSingleNewUnverifiedWakala.vue";

import ViewNewApprovedWakala from "./components/New_wakala/NewApprovedWakala.vue";
...
export default new VueRouter({
    routes: [
        ...
        {
            path: "/new_wakala/unverified",
            name: "view-new-wakala-unverified",
            component: ViewNewUnverifiedWakala
            // beforeEnter: guardMyroute
        },
        {
        ...
        {
            path: "/new-wakala/single/unverified",
            name: "view-new-wakala-single-unverified",
            component: ViewSingleNewUnverifiedWakala
            // beforeEnter: guardMyroute
        },
        {
        ...
        {
            path: "/new-wakala/approved",
            name: "view-new-wakala-approved",
            component: ViewNewApprovedWakala
            //beforeEnter: guardMyroute
        },
        {
