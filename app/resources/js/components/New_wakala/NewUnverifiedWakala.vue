<template>
    <div class="content-wrapper">
        <h4 class="content-heading">
            <div>
                M-pesa KYA Portal
                <p class="lead mt-2">New Unverified Wakala List</p>
            </div>
        </h4>
...
export default {
            ...
            axios
                ...
                .then(response => {
                    ...
                    if (items.length > 0) {
                        ...
                        this.message = "No available new wakala to verify !";
                    }
                ...
                .catch(error => {
                    ...
                    Toast.fire({
                        icon: "error",
                        title: "An error occured while fetching new wakala "
                    });
                });
        }, 2000);
    },
    methods: {
        doSomethingCool(e) {
            ...
            axios
                .post("/api/new_wakala/unverified", this.fields)
                .then(response => {
