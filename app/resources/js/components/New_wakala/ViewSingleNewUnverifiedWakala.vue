<template>
    <div class="content-wrapper">
        <h4 class="content-heading">
            <div>
                M-pesa KYA Portal
                <p class="lead mt-2">New Wakala Details</p>
            </div>
        </h4>
                        ...
                        <div class="card-body text-center">
                            <div class="py-4">
                                <img
                                    ...
                                    :src="'data:image/png;base64,' + wakala.Photo"
                                    alt="Contact"
                                />
                            </div>
    ...
    methods: {
        declineWakala() {
            if (this.loaded) {
                ...
                axios
                    .post("/api/new_wakala/verify", this.fields)
                    .then(response => {
                        loader.hide();
                        ...
                        this.success = true;
                            ...
                            Swal.fire({
                                icon: "success",
                                title: "Success",
                                text: "New wakala successfully declined"
                            }).then(() => {
                ...
                axios
                    ...
                    .then(response => {
                        ...
                        Swal.fire({
                            icon: "success",
                            title: "Success",
                            text: "New wakala succesfully accepted"
                        }).then(() => {
                            sessionStorage.clear();
                            window.location = "/home";
                        });
