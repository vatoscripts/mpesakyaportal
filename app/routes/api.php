...
Route::group(['middleware' => ['check-auth']], function () {
    ...
    /**
     * Routes concerned with onboarding of existing wakala
     */
    ...
    /**
     * Routes concerned with onboarding of new wakala
     */
    Route::get('new_wakala/unverified', 'API\WakalaController@getNewUnverifiedWakala');

    Route::post('new_wakala/unverified', 'API\WakalaController@viewNewUnverifiedWakala');

    Route::post('new_wakala/verify', 'API\WakalaController@verifyNewWakala');

    Route::get('new_wakala/approved', 'API\WakalaController@getNewApprovedWakala');
